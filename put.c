/* @(#) MQMBID sn=p920-002-210312 su=_cZGMVJI4Eeu4fNx-twSWJQ pn=samples/c/amqsput0.c */
 /********************************************************************/
 /*                                                                  */
 ...
 int main(int argc, char **argv)
 {
   ...
   strncpy(ClientConn.ConnectionName, "neha1.fyre.ibm.com(2319)", MQ_CONN_NAME_LENGTH);
   strncpy(ClientConn.ChannelName, "CHL", MQ_CHANNEL_NAME_LENGTH);
   strncpy(ClientConn.QMgrName, "PGM2A", 7); 
   cno.ClientConnPtr = &ClientConn;
   ClientConn.Version = MQCD_VERSION_7;
   strncpy(ClientConn.SSLCipherSpec, "TLS_RSA_WITH_AES_256_GCM_SHA384", MQ_SSL_CIPHER_SPEC_LENGTH);
